...
select chat_id from question where question_id = 8;
select * from question where chat_id=2;
...
SELECT q.question_id, q.question_text, '꼬리질문이 들어갑니다 1', '꼬리질문 팁1','인덱스 추가, 쿼리 리팩토링, EXPLAIN PLAN 사용 등이 있습니다.'
FROM question q
...
-- 아직 답변을 안한상태
INSERT INTO tail(question_id, question_text, tail_question, tail_tip, tail_answer) 
SELECT q.question_id, q.question_text, '꼬리질문이 들어갑니다 2', '꼬리질문 팁2',null
FROM question q
WHERE q.question_id = 1;
